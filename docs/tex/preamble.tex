...
\usepackage{titling}
\usepackage{tikz-timing} % Draw digital timing diagrams
\usepackage{etoolbox} %to modify thebibliography
...
%add section number to bibliography
...
% Load appendix rules
%\input{tex/preamble_appendix.tex}
